...
static class PrimitiveDescriptorExtensions
{
    static TypeSyntax ReadOnlySpanChar
        => GenericName(Identifier("ReadOnlySpan"))
                ...
                ParameterList(
                    SeparatedList<ParameterSyntax>(
                        new SyntaxNodeOrToken[]
                        {
                            ...
                            Token(SyntaxKind.CommaToken), Parameter(Identifier("value2"))
                                .WithType(IdentifierName(descriptor.Name))
                        })))
            .WithExpressionBody(
                ArrowExpressionClause(
                        ...
                        .WithArgumentList(
                            ArgumentList(
                                SeparatedList<ArgumentSyntax>(
                                    new SyntaxNodeOrToken[]
                                    {
                                        Argument(IdentifierName("format")), Token(SyntaxKind.CommaToken), Argument(IdentifierName("formatProvider"))
                                    })))))
            .WithSemicolonToken(Token(SyntaxKind.SemicolonToken));
                    ...
                    SeparatedList<ParameterSyntax>(
                        new SyntaxNodeOrToken[]
                        {
                            Parameter(Identifier("s"))
                                .WithType(inputType),
                            Token(SyntaxKind.CommaToken), Parameter(Identifier("format"))
                                .WithType(PredefinedType(Token(SyntaxKind.StringKeyword))),
                            Token(SyntaxKind.CommaToken), Parameter(Identifier("formatProvider"))
                                .WithType(IdentifierName("IFormatProvider")),
                            Token(SyntaxKind.CommaToken), Parameter(Identifier("styles"))
                                ...
                                .WithArgumentList(
                                    ArgumentList(
                                        SeparatedList<ArgumentSyntax>(
                                            new SyntaxNodeOrToken[]
                                            {
                                                Argument(IdentifierName("s")), Token(SyntaxKind.CommaToken), Argument(IdentifierName("format")),
                                                Token(SyntaxKind.CommaToken), Argument(IdentifierName("formatProvider")), Token(SyntaxKind.CommaToken),
                                                Argument(IdentifierName("styles")), Token(SyntaxKind.CommaToken),
